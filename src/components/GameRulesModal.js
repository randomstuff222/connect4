...
const GameRulesModal = () => {
  ...
  const [mark, setMark] = useState('#000000');
  function markOnHover(){
    setMark('#FFFFFF');
  }
  function markOnLeave(){
    setMark('#000000');
  }
  ...
  return (
    ...
    >
      <article className="game-rules-modal">
        ...
        <button className="check-mark-btn" onClick={closeGameRules} onMouseEnter={markOnHover}
          onMouseLeave={markOnLeave}>
          <svg
            width="70px"
            height="75px"
            viewBox="0 0 70 75"
